...
char *personalization = "RPO-sample-app";

#define LOG_INFO(...) __android_log_print(ANDROID_LOG_INFO, "RPO_ndk", __VA_ARGS__)

#define SLOG_INFO(...) android_logger->info( __VA_ARGS__ )
auto android_logger = spdlog::android_logger_mt("android", "RPO_ndk");

extern "C" JNIEXPORT jstring JNICALL
Java_com_example_rpo_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_rpo_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_com_example_rpo_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_rpo_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_rpo_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
Java_com_example_rpo_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
